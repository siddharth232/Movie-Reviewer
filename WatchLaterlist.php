 		...
 		<?php 
            ...
            if($result){
            	while($row=$result->fetch_assoc()){
            		echo"<tr><td><a href='Play.php?id=".$row['video_id']."&name=".$row['name']."'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$row['name']."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$row['reg_date']."</a></td></tr>";
            	}
            }
