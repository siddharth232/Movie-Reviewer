 ...
 <div id="content">
 	<table>
 		<?php 
 		  ...
 		  // $username='sid';
            $sql="SELECT * FROM favrt WHERE username='$username'";
            $result=$conn->query($sql);
            if($result){
            	while($row=$result->fetch_assoc()){
            		echo"<tr><td><a href='Play.php?id=".$row['videoid']."&name=".$row['name']."'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$row['name']."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$row['reg_date']."</a></td></tr>";
            	}
            }
